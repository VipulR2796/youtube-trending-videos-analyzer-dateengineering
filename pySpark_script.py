...
cleansed_s3_bucket_url = os.environ['cleansed_s3_bucket_url']

datasource0 = glueContext.create_dynamic_frame.from_catalog(database = raw_database_name, table_name = raw_table_name, transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": cleansed_s3_bucket_url, "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
